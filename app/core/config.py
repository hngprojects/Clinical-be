...
class Settings(BaseSettings):
    ...
    @classmethod
    def resend_from_email_required_when_resend_enabled(
    ...
    FRONTEND_RESET_PASSWORD_URL: str = (
        "https://staging.clinical-tool.hng14.com/reset-password"
    )
    FRONTEND_AUTH_CALLBACK_URL: str = (
        "https://staging.clinical-tool.hng14.com/auth/callback"
    )
