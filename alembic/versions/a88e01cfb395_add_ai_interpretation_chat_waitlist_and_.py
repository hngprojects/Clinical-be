...
def upgrade() -> None:
    ...
    # Copy data from singular to plural tables to prevent data loss
    op.execute('INSERT INTO users (id, email, password_hash, google_id, name, role, is_email_verified, is_active, created_at, last_login_at) SELECT id, email, password_hash, google_id, name, role::userrole, is_email_verified, is_active, created_at, last_login_at FROM "user"')
    op.execute('INSERT INTO medical_cases (id, user_id, guest_session_id, status, created_at, completed_at) SELECT id, user_id, guest_session_id, status, created_at, completed_at FROM medical_case')
    op.execute('INSERT INTO lab_results (id, medical_case_id, file, ocr_status, extracted_values, ocr_completed_at, created_at) SELECT id, medical_case_id, file, ocr_status, extracted_data, ocr_completed_at, created_at FROM lab_result')
...
def downgrade() -> None:
    ...
    # Copy data back
    op.execute('INSERT INTO "user" (id, email, password_hash, google_id, name, role, is_email_verified, is_active, created_at, last_login_at) SELECT id, email, password_hash, google_id, name, role::varchar, is_email_verified, is_active, created_at, last_login_at FROM users')
    op.execute('INSERT INTO medical_case (id, user_id, guest_session_id, status, created_at, completed_at) SELECT id, user_id, COALESCE(guest_session_id, \'\'), status, created_at, completed_at FROM medical_cases')
    op.execute('INSERT INTO lab_result (id, medical_case_id, file, ocr_status, extracted_data, ocr_completed_at, created_at) SELECT id, medical_case_id, file, ocr_status, COALESCE(extracted_values, \'{}\'), ocr_completed_at, created_at FROM lab_results')
